...
const commands_list = [
    ...
    `Use \`${prefix}suggest <suggestion>\` to send a suggestion to the bot suggestion server, where I keep track of ideas I can add, have added, or have rejected. Suggestions have to be at least 20 characters long and should provide an explanation of what your suggested feature/command does.`],
    ['level',
    `${prefix}level [user]`,
