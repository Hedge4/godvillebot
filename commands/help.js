...
const commands_list = [
    ...
    'This command will analyse a Godville user\'s profile, and return the most useful information from it, such as hero(ine) level, guild and achievements. For this command, the user does not have to be in the discord.',
