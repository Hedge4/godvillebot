...
const commands_list = [
    ...
    ['newspaper',
        ...
        `Every day, at 22:10 UTC (5 minutes after it changes), ${botName} automatically downloads and summarises the Godville Times, and then sends it in <#${channels.newspaper}>. These commands also work in that channel.`,
