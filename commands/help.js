...
const commands_list = [
    ...
    ['newspaper',
        ...
        `Every day, at 22:10 UTC (5 minutes after it changes), ${botName} automatically downloads and summarises the Godville Times, and then sends it in <#431305701021974539>. These commands also work in that channel.`,
        ...
        [`${prefix}newsdelay`, `Shows the time remaining before ${botName} automatically updates its Godville Time's summary.`],
    ...
    ['react',
        ...
        `Have ${botName} easily react multiple emojis for you to a message. You can enter a message URL or message ID to indicate the message you want to react to, or none of those to react to the most recent message in that channel.`],
    ['makevote',
        ...
        'Specify a number to get a multiple choice poll. If you don\'t, I will create an encourage/miracle/punish poll. If you don\'t supply a message ID or URL, assumes the most recent message.'],
    ['ping',
        `${prefix}ping`,
